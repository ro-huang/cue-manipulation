    ...
    def generate(
        ...
        out = self.model.generate(
            **enc,
            ...
            output_scores=True,
            output_hidden_states=capture_post_newline,
        ...
        if capture_post_newline and generated_ids.numel() > 0:
            ...
            if newline_step is not None:
                ...
                h = step_hs[layer_idx]
                # For step 0 the tensor may span the entire prompt. Take the last position.
