...
CONDITION_SPECS: dict[str, ConditionSpec] = {
    ...
    "whitespace": ConditionSpec(
        name="whitespace",
        description=(
            "Yoked content-free filler: same character count as random_paragraph, "
            "but only spaces. Disambiguates 'irrelevant content distracts' from "
            "'any prefix between system prompt and question changes the prefix length'."
        ),
        generator_instruction="",
        yoked=True,
    ),
